<?php /* Template Name: College Connection Template */ get_header(); ?>

		<?php if (have_posts()): while (have_posts()) : the_post(); ?>

			<!-- page_title -->
			<div class="page_title">
							<div class="page_title_bg_h1" style="padding-left: 125px;"><h1><?php echo get_post_meta($post->ID, 'top-level-page-heading', true); ?></h1></div>
							<div class="page_title_bg_h2" style="padding-left: 125px;"><h2><?php echo get_post_meta($post->ID, 'second-level-page-heading', true); ?></h2></div>
			</div>
			<!-- /page_title -->
